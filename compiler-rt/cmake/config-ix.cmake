...
if(APPLE)
  ...
  set(PLSAN_COMMON_SUPPORTED_ARCH ${SANITIZER_COMMON_SUPPORTED_ARCH})
  ...
  list_intersect(LSAN_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(PLSAN_SUPPORTED_ARCH
    ALL_PLSAN_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(PLSAN_SUPPORTED_ARCH ${ALL_PLSAN_SUPPORTED_ARCH})
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND PLSAN_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_PLSAN TRUE)
else()
  set(COMPILER_RT_HAS_PLSAN FALSE)
endif()
